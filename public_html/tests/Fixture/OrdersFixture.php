...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'deal_amount' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'fee' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'leverage_rate_id' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'source_order_id' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'price' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'price_average' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
...
'engine' => 'InnoDB', 'collation' => 'latin1_swedish_ci'
    ...
    public $records = [
        [
            ...
            'contract_id' => 1,
            'create_date' => 1430841242,
            'deal_amount' => 1,
            'fee' => 'Lorem ipsum dolor sit amet',
            'leverage_rate_id' => 'Lorem ipsum dolor sit amet',
            'source_order_id' => 'Lorem ipsum dolor sit amet',
            'price' => 'Lorem ipsum dolor sit amet',
            'price_average' => 'Lorem ipsum dolor sit amet',
            'status' => 'Lorem ipsum dolor sit amet',
            'symbol' => 'Lorem ipsum dolor sit amet',
            'order_type_id' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
