...
class CurrenciesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'currency_name' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'abbreviation' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'name_UNIQUE' => ['type' => 'unique', 'columns' => ['currency_name'], 'length' => []],
            'abbreviation_UNIQUE' => ['type' => 'unique', 'columns' => ['abbreviation'], 'length' => []],
        ],
        '_options' => [
