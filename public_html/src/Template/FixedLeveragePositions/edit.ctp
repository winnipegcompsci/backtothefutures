<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $fixedLeveragePosition->fixed_leverage_position_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $fixedLeveragePosition->fixed_leverage_position_id)]
            )
        ?></li>
...
<div class="fixedLeveragePositions form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Fixed Leverage Position') ?></legend>
        <?php
