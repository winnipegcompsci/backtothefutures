...
<ul class="nav nav-pills">
    ...
    <li><a href="#usepositions_bitvc" data-toggle="tab">BitVC</a></li>
</ul>

<div class="tab-content">
    <?php 
        $data = $okcoin_client->positionFutureApi(['symbol' => 'btc_usd', 'contract_type' => 'this_week', 'api_key' => $okcoin_apikey]);
    ?>
