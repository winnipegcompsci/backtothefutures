...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
            ...
            <li><a href="<?= $this->Url->build(['controller' => 'pages', 'action' => 'tradedash']); ?>"><span class="glyphicon glyphicon-dashboard"></span> Trading Dashboard</a></li>
			...
			<li role="presentation" class="divider"></li>
			<li><a href="<?= $this->Url->build(['controller' => 'sources', 'action' => 'index']); ?>"><span class="glyphicon glyphicon-cog"></span> Markets / Sources </a></li>
		</ul>
	</div><!--/.sidebar-->
